...
public class Biblioteca {
    ...
    //    Constructor copia
    public Biblioteca(Biblioteca biblioteca2) {
        this.nombre = biblioteca2.nombre;
        this.listaLibros = biblioteca2.listaLibros;
        this.listaBibliotecarios = biblioteca2.listaBibliotecarios;
    }
